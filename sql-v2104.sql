...
-- Dumping structure for table nhhoang.blog_comments
...
-- Dumping structure for table nhhoang.blog_media
...
-- Dumping structure for table nhhoang.review_media
...
-- Dumping structure for table nhhoang.typpe_media
CREATE TABLE IF NOT EXISTS `typpe_media` (
  `id` int NOT NULL AUTO_INCREMENT,
