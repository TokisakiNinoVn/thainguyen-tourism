...
CREATE TABLE IF NOT EXISTS `blogmedia` (
  ...
  `mediaType` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `createdAt` timestamp NULL DEFAULT NULL,
  `updatedAt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Dumping data for table nhhoang.blogs: ~1 rows (approximately)
INSERT INTO `blogs` (`id`, `authorId`, `title`, `place`, `content`, `status`, `thumbnail`, `createdAt`, `updatedAt`) VALUES
	(6, 1, 'test', 'Thành phố Thái Nguyên', 'Hi!', 'draft', 0, '2025-05-06 03:22:47', '2025-05-06 03:22:47'),
	(7, 1, 'dwqd', 'qdad', '<p>waadwada</p>', 'draft', 0, '2025-05-06 03:43:58', '2025-05-06 03:43:58');
...
INSERT INTO `chatdata` (`id`, `userId`, `content`, `type`, `responseChatId`, `createdAt`) VALUES
	...
	(94, 1, 'Ở Thái Nguyên có những địa điểm du lịch nổi bật nào?', 'request', NULL, '2025-05-06 01:34:45'),
	(95, 1, 'Thái Nguyên nổi tiếng với nhiều địa điểm hấp dẫn như Hồ Núi Cốc, Đồi chè Tân Cương, Khu di tích lịch sử ATK Định Hóa, chùa Hang, và bảo tàng các dân tộc Việt Nam.', 'response', 94, '2025-05-06 01:34:45');
...
-- Dumping data for table nhhoang.chatdefault: ~0 rows (approximately)
...
INSERT INTO `users` (`id`, `email`, `password`, `role`, `photoURL`, `displayName`, `createdAt`, `isGoogleLogin`, `tokenChat`) VALUES
	(1, 'nino@gmail.com', '$2b$10$1NfXyAgF5M9EJt5s/r6gneC2DUEiKjoJ.m1ETaZciIpwRQ5K2qHlW', 'admin', NULL, 'Bí khách ẩn danh', '2025-04-09 21:51:11', 0, 1),
